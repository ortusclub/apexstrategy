      ...
      <main id="main-content">
        <section className="pt-32 pb-16 hero-grid-bg">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <a
              href="#register"
              className="bg-accent hover:bg-accent-hover text-bg-primary font-semibold px-8 py-3.5 rounded-lg text-base transition-colors inline-flex items-center gap-2 mt-8"
            >
              Request your seat
            </a>
          </div>
        ...
        <section className="pb-8">
          <div className="max-w-3xl mx-auto px-6 flex flex-col gap-14">
            ...
            <Block title="The Conversation" paragraphs={dinner.conversation} />
        ...
        <div className="mt-16">
          <RegisterForm
            eventId={dinner.slug}
            intro={`${dinner.dateLabel} · ${dinner.locality}. A quick 30 seconds — we'll confirm by email within one business day.`}
          />
        </div>
      </main>
